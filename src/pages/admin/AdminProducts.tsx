    ...
    <div className="p-6">
      ...
      <div className="flex flex-col md:flex-row gap-2 mb-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            className="border border-gray-300 rounded-md px-3 py-2 flex items-center gap-1"
          >
        ...
        {filteredProducts.map((product) => (
          <div key={product.id} className="bg-white rounded-lg overflow-hidden border border-gray-200">
            ...
            <div className="p-4">
              ...
              <button className="mt-4 text-blue-600 hover:text-blue-800 flex items-center justify-end w-full text-sm font-medium">
                Ver detalles
      ...
      {modalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-6 shadow-lg w-full max-w-2xl">
            <h2 className="text-2xl font-bold text-black mb-1">Agregar Nuevo Producto</h2>
            <p className="text-sm text-gray-600 mb-6">Complete el formulario para agregar un nuevo producto al inventario.</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="md:col-span-2">
                ...
                <textarea className="w-full border px-3 py-2 rounded-lg" rows={3}></textarea>
              </div>
              <div>
                <label className="text-sm font-medium">Cantidad en Stock</label>
                <input type="number" className="w-full border px-3 py-2 rounded-lg" />
              </div>
              <div>
              ...
              <div className="md:col-span-2">
                ...
                <input type="file" className="w-full border px-3 py-2 rounded-lg" />
              </div>
